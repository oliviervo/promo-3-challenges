...
def exactly_divide(an_integer, a_divider)
  ...
  an_integer=an_integer.to_f
  a_divider=a_divider.to_f
...
def random_subset(an_array, sample_size)
  ...
  an_array.to_a.shuffle.take(sample_size)


end
random_subset((1..100), 5)

def randomize(an_array)
  # TODO: return a randomized copy of an_array
  # example: randomize([1, 2, 3, 4]) => [2, 1, 4, 3]
  an_array.to_a.shuffle
end
randomize (1..100)
...
def ascending_order(an_array)
  ...
  an_array.to_a.sort { |x,y| y <=> x }
end
ascending_order(1..100)