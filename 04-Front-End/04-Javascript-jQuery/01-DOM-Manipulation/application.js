...
var newmail = $('#email').val('qqqss.com')

  // Ex 3. Replace the email hint (next to the input) with 'This is my email now'
  //       The text should be emphasized using a <strong> tag
var message = $('#email-hint').html("<strong>This is my email now</strong>");

  // Ex 4. Add the .blue CSS class to the table header cells (th elements)
var tableblue = $('th').addClass('blue')
...
var add_team = $('tbody').append('<tr><td>15</td></tr>');
  ...
  var ChangeBackgroundColor = $('th').css("background-color", "#DDF4FF");
  ...
  var RemoveEmailLabel = $('label').replaceWith();
